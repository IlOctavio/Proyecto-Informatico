 ...
 */
spawn(
  `ng serve --host ${appConfig.ui.host} --port ${appConfig.ui.port} --serve-path ${appConfig.ui.nameSpace} --ssl ${appConfig.ui.ssl} --disable-host-check ${process.argv.slice(2).join(' ')} --configuration development`,
